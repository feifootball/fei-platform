        ...
        <div className="flex items-center justify-between rounded-full border border-white/10 bg-[#070b12]/90 px-4 py-3 shadow-[0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:px-5">
          ...
          <div className="hidden items-center gap-2 md:flex">
            <a
              ...
              className="inline-flex h-9 w-9 items-center justify-center rounded-full text-white/40 transition hover:bg-white/[0.06] hover:text-fei-sky"
              aria-label="FEI Instagram"
            >
              <InstagramIcon />
            </a>
          ...
          <div className="flex items-center gap-2 md:hidden">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden h-10 w-10 items-center justify-center rounded-full text-white/45 transition hover:bg-white/[0.06] hover:text-fei-sky xs:inline-flex"
              aria-label="FEI Instagram"
            >
              <InstagramIcon />
            </a>
          ...
          <div className="mt-3 overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#070b12]/95 p-3 shadow-[0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl md:hidden">
            <div className="grid gap-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className="rounded-2xl px-4 py-3 text-base font-medium text-white/75 transition hover:bg-white/[0.06] hover:text-white"
                >
                  {link.label}
                </a>
              ))}
            ...
            <div className="mt-3 flex items-center gap-2 border-t border-white/10 pt-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/10 text-white/55 transition hover:bg-white/[0.06] hover:text-fei-sky"
                aria-label="FEI Instagram"
              >
                <InstagramIcon />
              </a>
