      ...
      <nav className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-4 sm:gap-6">
            <a href="#get-started" className="hidden text-sm text-fei-text/60 hover:text-fei-text transition-colors sm:block">About</a>
            <a href="#get-started" className="hidden text-sm text-fei-text/60 hover:text-fei-text transition-colors sm:block">Roles</a>
