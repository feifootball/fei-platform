...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      // Obtener full_name desde metadata de auth primero, luego profiles
      ...
      <main className="px-6 py-12">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <div>
            ...
            {userRole && <p className="mt-2 text-fei-text/50">{userRole}</p>}
          </div>
              ...
              <div className="rounded-2xl border border-fei-text/10 bg-fei-text/[0.03] p-6">
                ...
                <div className="mt-4 space-y-2">
                  {['A2', 'B1', 'B2', 'C1'].map((lvl) => {
                    ...
                    const currentIdx = levels.indexOf(lastAssessment.level)
                    ...
                    return (
                      <div key={lvl} className="flex items-center gap-2">
                        ...
                        <div className="flex-1 h-1.5 rounded-full bg-fei-text/10">
                          <div className={`h-1.5 rounded-full ${lvlIdx <= currentIdx ? 'bg-fei-yellow' : 'bg-fei-text/10'}`} style={{ width: lvlIdx <= currentIdx ? '100%' : '0%' }} />
                        </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Link href="/learning" className="group rounded-2xl border border-fei-text/10 bg-fei-text/[0.03] p-6 transition hover:border-fei-sky/30 hover:bg-fei-sky/[0.04]">
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-fei-sky/10 text-fei-sky">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-5 w-5"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg>
              </div>
            ...
            <Link href="/notifications" className="group relative rounded-2xl border border-fei-text/10 bg-fei-text/[0.03] p-6 transition hover:border-fei-sky/30 hover:bg-fei-sky/[0.04]">
              ...
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-fei-sky/10 text-fei-sky">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-5 w-5"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg>
              </div>
            ...
            <Link href="/settings" className="group rounded-2xl border border-fei-text/10 bg-fei-text/[0.03] p-6 transition hover:border-fei-sky/30 hover:bg-fei-sky/[0.04]">
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-fei-sky/10 text-fei-sky">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="h-5 w-5"><circle cx="12" cy="12" r="3" /><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32 1.41 1.41M2 12h2m16 0h2M4.93 19.07l1.41-1.41m11.32-11.32 1.41-1.41" /></svg>
              </div>
