  ...
  reading: [
    {
      ...
      options: [
        'A. The team slowed the game down.',
        'B. The team tried to attack quickly after regaining possession.',
        'C. The striker dropped into midfield.',
        'D. The winger stayed close to the fullback.',
      ],
      correct: 'B',
    },
    {
      ...
      options: [
        'A. The opponent always plays long from the goalkeeper.',
        'B. The right side changes shape during build-up.',
        'C. The midfielder stays high to occupy the final third.',
        'D. The fullback remains deep during possession.',
      ],
      correct: 'B',
    },
    {
      ...
      options: [
        'A. The forwards were mainly responsible for the lack of chances.',
        'B. The team should attempt more crosses.',
        'C. The difficulty in progressing the ball began before the final third.',
        'D. The team lost possession because it played too many forward passes.',
      ],
      correct: 'C',
    },
    {
      ...
      options: [
        'A. The team should always attack behind the left fullback.',
        'B. The left fullback is the opponent’s main defensive weakness.',
        'C. The space behind the fullback becomes more exploitable when the covering center-back is also drawn forward.',
        'D. The opponent should stop using the fullback in attack.',
      ],
      correct: 'C',
    },
  ],
  listening: [
    {
      ...
      options: [
        'A. Space inside for the midfielder.',
        'B. More pressure on the goalkeeper.',
        'C. A deeper defensive line.',
        'D. Less width in attack.',
      ],
      correct: 'A',
    },
    {
      ...
      options: [
        'A. A forward pass into midfield.',
        'B. A backward pass to the center-back.',
        'C. The goalkeeper playing long.',
        'D. The fullback moving inside.',
      ],
      correct: 'B',
    },
    {
      ...
      options: [
        'A. More possession meant the team controlled the match better.',
        'B. The opponent became more aggressive after halftime.',
        'C. The increase in possession did not necessarily mean effective progression.',
        'D. The team created more chances because it had more of the ball.',
      ],
      correct: 'C',
    },
    {
      ...
      options: [
        'A. The players need to take fewer risks in possession.',
        'B. Passing technique was the main reason for the turnovers.',
        'C. The turnovers were often linked to the team’s spacing before the technical error occurred.',
        'D. The attacking line should stay deeper during possession.',
      ],
      correct: 'C',
    },
  ],
  vocabulary: [
    {
      ...
      options: [
        'A. The group of defenders positioned across the back of the team.',
        'B. The space between midfield and attack.',
        'C. The area where the goalkeeper starts possession.',
        'D. The players who press closest to the opponent’s goal.',
      ],
      correct: 'A',
    },
    {
      ...
      options: [
        ...
        'B. A pass that moves the ball meaningfully toward the opponent’s goal.',
        'C. A pass made only by an attacking midfielder.',
        'D. A pass played immediately after a tackle.',
      ],
      correct: 'B',
    },
    {
      ...
      options: [
        'A. Force the opponent to defend closer to its own goal.',
        'B. Move the ball beyond an opposition line through a pass or movement.',
        'C. Change the defensive shape after losing possession.',
        'D. Increase the distance between two units.',
      ],
      correct: 'B',
    },
    {
      ...
      options: [
        'A. A repeated structural issue that helps explain the visible outcome.',
        'B. The final action that directly causes possession to be lost.',
        'C. A statistical trend that appears only in post-match data.',
        'D. An individual mistake that happens several times in one game.',
      ],
      correct: 'A',
    },
  ],
