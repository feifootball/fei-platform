  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-fei-bg px-6">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handlePasswordReset} className="rounded-2xl border border-fei-text/10 bg-fei-text/[0.03] p-8">
          <h1 className="mb-3 text-2xl font-bold text-fei-text">Reset your password</h1>
